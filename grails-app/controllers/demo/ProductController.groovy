...
class ProductController extends BaseController{
    ...
    def showCart(){
        ...
        // get all data from database (not dublicate)
        // render view
    ...
    private void upload(def params){
        ...
        if(file) {
            file.transferTo(new File(path + "/images/products/${file.getOriginalFilename()}"))
            params.remove('image')
    ...
    def sendEmail() {
        ...
        mailService.sendMail {
            ...
            while (i.hasNext()) {
                ...
                bodyString += "Product Name: " +obj.get("name")+"<br>";
                bodyString += "Price: " +obj.get("price")+"<br>";
            }*/
